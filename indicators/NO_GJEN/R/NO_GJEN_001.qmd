...
```{r coverage-map-enc, fig.height=6, fig.width=12, fig.cap="Map of Norway showing coverage of different data sets per 10x10km gridcell."}
...
```{r coverage-map-forestheight, fig.height=5, fig.width=5, fig.cap="Map of Norway showing 90th percentile forest heights per region-bioclimatic zone strata."}
